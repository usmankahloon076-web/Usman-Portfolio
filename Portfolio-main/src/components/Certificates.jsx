...
const CertificateCard = ({ cert, aosDelay }) => {
  ...
  return (
    <a 
      ...
      rel={cert.fileUrl ? "noopener noreferrer" : undefined}
      data-aos="zoom-in"
      data-aos-delay={aosDelay}
      className="bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/40 hover:scale-105 hover:bg-black/35 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 block cursor-pointer group"
    >
      {content}
    </a>
  );
